...
create table public.profiles (
  ...
  seriousness_score numeric(5,2) default 0,
...
-- 6. Auto-create profile + default 'client' role on signup
...
create policy "Users can add client/provider role to themselves"
